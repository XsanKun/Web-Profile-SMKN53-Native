...
<body>
	...
	$base_url = "http://localhost/uasnative2021/" 
	?>
	<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #15477A;">
		<div class="container">
			<ul class="navbar-nav text-white">
				...
				<li class="nav-item">
					<a class="nav-link <?= $active == 'sambutan' ? 'active' : '' ?> " href="<?= $base_url ?>admin/sambutan.php">Sambutan</a>
				</li>
				<li class="nav-item">
					<a class="nav-link <?= $active == 'kontak' ? 'active' : '' ?> " href="<?= $base_url ?>admin/kontak.php">Kontak</a>
				</li>
				<li class="nav-item">
					<a class="nav-link <?= $active == 'tentang_website' ? 'active' : '' ?> " href="<?= $base_url ?>admin/tentang_website.php">Tentang</a>
				</li>
				<li class="nav-item">
